...
return function(RouteCollector $r) {
    ...
    $r->addRoute('GET', '/catalog', [
        'controller' => \App\Kitchen\app\Http\Controllers\Catalog\CatalogController::class,
        'method'     => 'index'
    ]);
    ...
    $r->addRoute('GET', '/ajax/catalog/products', [
        'controller' => \App\Kitchen\app\Http\Controllers\Catalog\CatalogProductController::class,
        'method'     => 'ajaxGetAll'
    ]);
